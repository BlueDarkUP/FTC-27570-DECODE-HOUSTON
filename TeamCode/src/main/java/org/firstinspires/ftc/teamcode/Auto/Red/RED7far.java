...
@Autonomous(name = "红方远点自动", group = "Autonomous")
public class RED7far extends OpMode {
    ...
    private final double TURRET_SHOOT_ANGLE = 69.0; // 蓝方-68.0取反
    ...
    public void buildPaths() {
        ...
        // 6. 发射点 -> 停靠 (X 144-59=85, 90度朝向镜像后依然是90度)
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 12:
                ...
                break;
            case 13:
                // 等待飞轮加速到至少4070转（仅第一次发射需要严格检测此条件）
