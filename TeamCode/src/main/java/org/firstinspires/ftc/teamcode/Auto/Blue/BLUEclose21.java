...
public class BLUEclose21 extends OpMode {
    ...
    public void buildPaths() {
        ...
        huiqufashe1 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(255))
                .build();
        ...
        kaimenzuo1 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(255), Math.toRadians(157))
                .build();
        ...
        huiqufashe2 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(157), Math.toRadians(255))
                .build();
